        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('backend/assets/images/logo-light.png') }}" alt="logo-light" height="59">
                    </span>
                </a>
            </div>
...
<a class="dropdown-item" href="{{ route('change.password') }}"><i class="ri-lock-password-line"></i> Change Password</a>
